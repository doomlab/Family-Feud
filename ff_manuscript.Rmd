...
####table set up####
##create a blank table
tableprint2 = matrix(NA, nrow = 6, ncol = 7)
...
tableprint2[3:4 , 3:7 ] = summary(model4)$tTable[-c(1:2) , ]
tableprint2[5, 1] = "Simple Slope"
tableprint2[5, 2:3] = c("C", "Points")
tableprint2[5 , 3:7 ] = summary(model3.c)$tTable[-1 , ]  ##I think there are two model3.c
tableprint2[6, 1] = "Simple Slope"
tableprint2[6, 2:3] = c("D", "Points")
...
####table set up####
##create a blank table
tableprint3 = matrix(NA, nrow = 8, ncol = 6)
...
tableprint3[3:4 , 3:6 ] = coef(summary(model11.1))[-c(1:2), ]
tableprint3[5:6, 1] = "Simple Slope"
tableprint3[5:6, 2] = c("A Groups", "Points")
tableprint3[5:6 , 3:6 ] = coef(summary(model11.d))[-1, ]
tableprint3[7:8, 1] = "Simple Slope"
tableprint3[7:8, 2] = c("A Singles", "Points")
tableprint3[7:8 , 3:6 ] = coef(summary(model11.c))[-1, ]
...
tableprint4[3:4 , 3:7 ] = summary(model15)$tTable[-c(1:2) , ]
tableprint4[5:6, 1] = "Simple Slope"
tableprint4[5:6, 2] = c("D Groups", "Points")
tableprint4[5:6 , 3:7 ] = summary(model17)$tTable[-1 , ]
tableprint4[7:8, 1] = "Simple Slope"
tableprint4[7:8, 2] = c("D Singles", "Points")
tableprint4[7:8 , 3:7 ] = summary(model16)$tTable[-1 , ]

#APA Format
tableprint4[ , 3:6] = printnum(as.numeric(tableprint4[ , 3:6]))
#tableprint4[ , 7] = printp(as.numeric(tableprint4[ , 7])) #Doing the same thing as table 3
