...
tableprint = matrix(NA, nrow = 22, ncol = 6)
colnames(tableprint) = c("Model", "Predictor", "$b$", "$SE$", "$z$", "$p$")

tableprint[1:2, 1] = "Main Effects"
tableprint[1:2, 2] = c("A vs B", "Points")
tableprint[1:2 , 3:6 ] = coef(summary(model7))[-1, ]
```
...
####table set up####
##create a blank table
tableprint = matrix(NA, nrow = 22, ncol = 7)
colnames(tableprint) = c("Model", "Predictor", "$b$", "$SE$", "$df$", "$t$", "$p$")

tableprint[1:2, 1] = "Main Effects"
tableprint[1:2, 2] = c("C vs D", "Points")
tableprint[1:2 , 3:7 ] = summary(model3)$tTable[-1 , ]
