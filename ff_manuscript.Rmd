...
colnames(tableprint) = c("Model", "Predictor", "$b$", "$SE$", "$z$", "$p$")

tableprint1[1:2, 1] = "Main Effects"
tableprint1[1:2, 2] = c("A vs B", "Points")
tableprint1[1:2 , 3:6 ] = coef(summary(model7))[-1, ]
tableprint1[3:4, 1] = "Interactions"
tableprint1[3:4, 2] = c("A vs B", "Points")
tableprint1[3:4 , 3:6 ] = coef(summary(model8))[-1, ]
tableprint1[5, 1] = "Simple Slope"
tableprint1[5, 2] = c("A", "Points")
tableprint1[5 , 3:6 ] = coef(summary(model3.c))[-1, ]
tableprint1[6, 1] = "Simple Slope"
tableprint1[6, 2] = c("B", "Points")
tableprint1[6 , 3:6 ] = coef(summary(model3.d))[-1, ]
```
...
####table set up####
##create a blank table
tableprint2 = matrix(NA, nrow = 8, ncol = 7)
...
tableprint2[3:4, 1] = "Interaction"
tableprint2[3:4, 2] = c("C vs D", "Points")
tableprint2[3:4 , 3:7 ] = summary(model4)$tTable[-1 , ]
tableprint2[5, 1] = "Simple Slope"
tableprint2[5, 2] = c("C", "Points")
tableprint2[5 , 3:7 ] = summary(model3.c)$tTable[-1 , ]
tableprint2[6, 1] = "Simple Slope"
tableprint2[6, 2] = c("D", "Points")
tableprint2[6 , 3:7 ] = summary(model3.d)$tTable[-1 , ]
```
...
####table set up####
##create a blank table
tableprint3 = matrix(NA, nrow = 6, ncol = 6)
...
tableprint3[3:4, 1] = "Interactions"
tableprint3[3:4, 2] = c("A singles vs A groups", "Points")
tableprint3[3:4 , 3:6 ] = coef(summary(model11.1))[-1, ]
tableprint3[5, 1] = "Simple Slope"
tableprint3[5, 2] = c("A Groups", "Points")
tableprint3[5 , 3:6 ] = coef(summary(model11.d))[-1, ]
tableprint3[6, 1] = "Simple Slope"
tableprint3[6, 2] = c("A Singles", "Points")
tableprint3[6 , 3:6 ] = coef(summary(model11.c))[-1, ]
...
####table set up####
##create a blank table
tableprint4 = matrix(NA, nrow = 8, ncol = 7)
...
tableprint4[3:4, 1] = "Interaction"
tableprint4[3:4, 2] = c("D Groups Versus Single", "Points")
tableprint4[3:4 , 3:7 ] = summary(model15)$tTable[-1 , ]
tableprint4[5, 1] = "Simple Slope"
tableprint4[5, 2] = c("D Groups", "Points")
tableprint4[5 , 3:7 ] = summary(model17)$tTable[-1 , ]
tableprint4[6, 1] = "Simple Slope"
tableprint4[6, 2] = c("D Singles", "Points")
tableprint4[6 , 3:7 ] = summary(model16)$tTable[-1 , ]
